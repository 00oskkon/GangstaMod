...
namespace GangstaMod.Content.Projectiles
{
    public class UnrealRound : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Unreal Bullet");
            ProjectileID.Sets.TrailCacheLength[Projectile.type] = 5;
            ProjectileID.Sets.TrailingMode[Projectile.type] = 0;

            // Cultist res to homing
        ...
        // Absolutley not just stolen off the internet
        // Code to replicate the Chlorophyte bullet AI
        // I have no idea what this does or how it works but nothing seems to be wrong in the game
        public override void AI()
        {
            ...
            Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, 166, Projectile.velocity.X * -0.5f, Projectile.velocity.Y * -0.5f);
        }
